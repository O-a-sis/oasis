								...
								<li class="listline">
									<ul class="ulinner">
										...
										<li class="innerl"><i class="fa-regular fa-star"></i></li>
											...
											<li class="mo" id="storemodal"> <input
												type="hidden" value="${item.S_NAME}" id="s_name">
												<input type="hidden" id="${item.ADDRESS1}"
												name="address1">
												<input
												type="hidden" value="${item.ADDRESS2}" id="address2">
												<input
												type="hidden" value="${item.S_PHONE}" id="s_phone">
