							...
							<c:forEach var="item" items="${list }">
								...
								<tr>
									...
									<td><c:choose>
											...
											<c:otherwise>
												<a
													href="/Oasis/admin/storeDown.oa?STORE=${item.STORE}&page=${param.page}">폐쇄하기</a>
											</c:otherwise>
										</c:choose></td>
								</tr>
							</c:forEach>
						...
						<form id="writeForm" class="form-horizontal" method="POST"
							...
							<div class="joinfom">
								<label class="jointit">지점ID</label><br /> <input class="putfom"
									...
									name="STORE" placeholder="ID 입력하세요" readonly
									oninput="checkID()" required> <label id="STORELABEL"></label>
							</div>

							<!-- 비밀번호 -->
							<div class="joinfom">
								<label for="jointit">지점PW</label><br /> <input class="putfom"
									type="text" class="form-control" id="S_PASSWORD"
									name="S_PASSWORD" placeholder="비밀번호 입력하세요" required /> <label
									id="PASSWORDW"></label>
							</div>
							...
							<div class="joinfom">
								<label>지점명</label><br /> <input class="putfom" type="text"
									...
									placeholder="지점명 입력하세요" class="form-control"
									oninput="checkName()" required> <label id="NAMEW"></label>
							</div>

							<!-- 지점장 이름 -->
							<div class="joinfom">
								<label>지점장</label><br /> <input class="putfom" type="text"
									minlength="2" class="form-control" id="S_MANAGER"
									name="S_MANAGER" placeholder="이름을 입력하세요" required> <label
									id="MANAGERW"></label>
							</div>

							<!-- 휴대전화 -->
							<div class="joinfom">
								<label>지점번호</label><br /> <input class="putfom" type="text"
									class="form-control" id="S_PHONE" name="S_PHONE"
									placeholder="'-' 없이 번호만 입력해주세요" required> <label
									id="PHONEW"></label>
							</div>
